...
class VehicleCreate(BaseModel):
    """
    Fields submitted by the customer when registering a vehicle.
    registration_number is NOT provided by the customer — it is
    auto-generated by the backend as INS-VEH-YYYY-NNNNN.
    This is an InsureAI system reference ID, not an official
    government/RTO registration number.
    """
    make: str
    model: str
