...
import { customerApi, type CustomerProfile, ApiError } from "../../lib/api";
...
export default function UserAddressCard() {
  ...
  const handleSave = async () => {
    ...
    setMsg(null);
    try {
      const updated = await customerApi.updateProfile({ address });
      setProfile(updated);
  ...
  // Only customers have an address field
