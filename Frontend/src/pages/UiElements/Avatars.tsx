...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | InsureAI - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for InsureAI - React.js Tailwind CSS Admin Dashboard Template"
      />
