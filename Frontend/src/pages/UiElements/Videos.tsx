...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | InsureAI - React.js Admin Dashboard Template"
        description="This is React.js Videos page for InsureAI - React.js Tailwind CSS Admin Dashboard Template"
      />
